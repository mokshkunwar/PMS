...
def generate_password():
    ...
    try:
        ...
        row = df.loc[df['Username'] == username and df['System'] == system]
    except:
    ...
    if row.empty:
        ...
        return render_template('user_login.html', message = "Password generated for {} is {}".format(username, generated_password))
    else:
    ...
    if criteria_satisfied == False:
        ...
        # if row.empty:
            ...
            return render_template('register.html',
                                   message="The password is already generated for this user for {} system".format(
                                       system))
...
def login():
    ...
    with open("./admins.json", 'r') as file:
        ...
        for key in json_data:
            if username == key['username'] and password == key['password'] and system == key['system']:
